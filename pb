...
scanButton.Size = UDim2.new(0.5, -5, 0, 32)
scanButton.Position = UDim2.new(0, 5, 0, 124)
scanButton.BackgroundColor3 = Color3.fromRGB(0, 170, 0)
...
availableLabel.Size = UDim2.new(0.5, -5, 0, 32)
availableLabel.Position = UDim2.new(0.5, 0, 0, 124)
...
print("Bait Giver UI Loaded! Targets winter_2025_yarn_beanie_bait only.")
